    ...
    $.fn.fSelect = function(options) {
        ...
        fSelect.prototype = {
            create: function() {
                ...
                var BtnFixed = '<div class="btnFixed"><button class="buttonDefault" id="selectAllBtn" type="button" style="width:100px">Select all</button><button class="buttonDefault" id="clearAllBtn" type="button" style="width:100px">Clear all</button></div>';
