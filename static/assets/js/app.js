...
function respond(user_input) {
    var answer = "Sorry I dont understand"
    if (user_input.toLowerCase().includes("hi") || user_input.toLowerCase().includes("hello")) {
        answer = "Hello there, please ask a question!";
    } else {
        info.forEach(paragraph => {
            if (paragraph.toLowerCase().includes(user_input.toLowerCase())) {
                answer = paragraph
            }
        })
    }
