...
const responses = {
    ...
    1: "There are 3 main types, type 1, type 2 and gestational diabetes, all being complex and serious. <a href='../guide#types'>Read more</a>",
    2: "Type 1 diabetes is a chronic medical condition where cells that make insulin are destroyed, hence the body is unable to process glucose due to the lack of insulin. <a href='../guide#type1'>Read more</a>",
    3: "Type 2 diabetes is a chronic medical condition where your body is not able to respond to insulin as well as it should. In later stages, it also many not produce enough insulin. When uncontrolled, may lead to chronically high blood glucose levels, leading to serious complications.  <a href='../guide#type2'>Read more</a>",
    4: "Gestational diabetes typically develops between the 24th to 28th week of pregnancy. Although not indicative of having diabetes before or after pregnancy, it raises the risk of type 2 diabetes in the future. If poorly managed, it can raise the child's chance of developing diabetes and create complications during pregnancy and delivery.  <a href='../guide#gestational'>Read more</a>",
    5: "Hypoglycemia happens when blood glucose falls low, possibly a side effect of insulin. Severely low blood glucose can cause serious complications, including passing out, coma, or death. Symptoms include rapid heartbeat, sweating, confusion, slurred speech, numbness in fingers, toes and lips  <a href='../guide#hypoglycemia'>Read more</a>",
    6: "Being thirsty, needing to pee, always feeling hungry, itching, losing weight  <a href='../guide#symptoms'>Read more</a>",
    7: "Available commands:<br>?diet, ?treatment, ?diary",
    8: "Healthy eating is essential! REDIRECTING YOU TO THE GUIDE",
